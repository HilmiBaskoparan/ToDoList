...
export const deleteAllService = async () => {
  const response = await axios.delete(
    "http://localhost:4040/api/v1/todo/delete/all"
  );
  return response;
};
...
export const deleteCompletedTasksService = async () => {
  const response = await axios.delete(
    "http://localhost:4040/api/v1/todo/delete/completed"
  );
  return response;
};
...
export const getCompletedTasksService = async () => {
  const response = await axios.get(
    "http://localhost:4040/api/v1/todo/list/completed"
  );
  return response;
};
...
export const getUncompletedTasksService = async () => {
  const response = await axios.get(
    "http://localhost:4040/api/v1/todo/list/incompleted"
  );
  return response;
};